...
@section("main-content")
    ...
    <form class="row g-2" action={{ route("projects.update", $project) }} method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="sito web..." value={{ $project->name }}>
        </div>
        <div class="mb-3 col-6">
            <label for="client" class="form-label">Cliente</label>
            <input type="text" class="form-control" name="client" id="client" placeholder="Mario Rossi" value={{ $project->client }}>
        </div>
